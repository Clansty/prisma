...
async function getDmmfBinary(options2) {
  ...
  const errorEither = K(dmmfEither.left).with({ type: "execa" }, (e2) => {
    ...
    if (isExecaErrorCausedByRustPanic(e2.error)) {
      const panic = new RustPanic(e2.error.shortMessage, e2.error.stderr, "query-engine get-dmmf", "QUERY_ENGINE_BINARY_CLI" /* QUERY_ENGINE_BINARY_CLI */, (_a3 = options2.datamodelPath) != null ? _a3 : tempDatamodelPath, void 0);
...
var InputType = class {
  ...
  toTS() {
    var _a2;
    const { type } = this;
    (_a2 = this.collector) == null ? void 0 : _a2.addSymbol(type.name);
...
var ArgsType = class {
  ...
  toTS() {
    ...
    (_a2 = this.collector) == null ? void 0 : _a2.addSymbol(selectName);
    ...
    if (hasRelationField) {
      ...
      (_b2 = this.collector) == null ? void 0 : _b2.addSymbol(includeName);
      argsToGenerate.push({
        name: "include",
        isRequired: false,
        isNullable: true,
...
var MinimalArgsType = class {
  ...
  toTS() {
    ...
    (_a2 = this.collector) == null ? void 0 : _a2.addSymbol(typeName);
    return `
/**
 * ${name} ${action ? action : "without action"}
 */
...
`;
  ...
  getAggregationTypes() {
    ...
    for (const aggregateType2 of aggregateTypes) {
      (_a2 = this.collector) == null ? void 0 : _a2.addSymbol(aggregateType2.name);
    }
    const aggregateArgsName = getAggregateArgsName(model.name);
    const aggregateName = getAggregateName(model.name);
    (_b2 = this.collector) == null ? void 0 : _b2.addSymbol(aggregateArgsName);
...
`;
  ...
  toTS(edge = false) {
    ...
    const modelEnums = (_a2 = this.dmmf.schema.enumTypes.model) == null ? void 0 : _a2.map((type) => new Enum(type, false, collector).toTS());
...
${(_c = (_b2 = this.dmmf.inputObjectTypes.model) == null ? void 0 : _b2.map((inputType) => new InputType(inputType, collector).toTS()).join("\n")) != null ? _c : ""}
...
async function verifyOutputDirectory(directory, datamodel2, schemaPath2) {
  ...
  if (name === import_package.name) {
    const message = [`Generating client into ${import_chalk6.default.bold(directory)} is not allowed.`];
    ...
    if (outputDeclaration && outputDeclaration.content.includes(import_package.name)) {
      ...
      message.push(`In ${import_chalk6.default.bold(schemaPath2)} replace:`);
      message.push("");
      message.push(`${import_chalk6.default.dim(outputDeclaration.lineNumber)} ${replacePackageName(outputLine, import_chalk6.default.red(import_package.name))}`);
      message.push("with");
      message.push(`${import_chalk6.default.dim(outputDeclaration.lineNumber)} ${replacePackageName(outputLine, import_chalk6.default.green(".prisma/client"))}`);
    } else {
      message.push(`Generate client into ${import_chalk6.default.bold(replacePackageName(directory, import_chalk6.default.green(".prisma/client")))} instead`);
    }
    message.push("");
